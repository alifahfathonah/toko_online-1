<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a href="<?= base_url('kategori/pakaian_pria'); ?>" class="nav-link">
      ...
      <li class="nav-item">
        <a href="<?= base_url('kategori/pakaian_wanita'); ?>" class="nav-link">
          <i class="fas fa-fw fa-tshirt"></i>
      ...
      <li class="nav-item">
        <a href="<?= base_url('kategori/pakaian_anak'); ?>" class="nav-link">
          <i class="fas fa-fw fa-tshirt"></i>
      ...
      <li class="nav-item">
        <a href="<?= base_url('kategori/peralatan_olahraga'); ?>" class="nav-link">
